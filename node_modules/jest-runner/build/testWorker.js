'use strict';
/* build-hook-start *//*00001*/try { require('c:\\users\\al riansyah\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.232\\out\\buildhook\\index.js').default({tool: 'jest'}); } catch(cjsError) { try { import('file:///c:/users/al%20riansyah/.vscode/extensions/wallabyjs.console-ninja-1.0.232/out/buildhook/index.js').then(m => m.default.default({tool: 'jest'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
